...
DATABASES = {
    'default': {
        ...
        'NAME': DEV_DATABASE, #'wpqvsdmk', # hackernews
        'USER': DEV_USER, # 'wpqvsdmk', #m
        'PASSWORD': DEV_PASSWORD, #'cyeOfsIxKY1qKtgoIhkiGQUZN89s44_R', #adsoft
        'HOST': DEV_HOST, # 'heffalump.db.elephantsql.com', #localhost
        'PORT': DEV_PORT, #5432,
    }
}
