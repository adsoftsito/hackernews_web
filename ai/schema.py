...
LINEAR_SERVER_URL = 'https://linear-model-service-adsoftsito.cloud.okteto.net/v1/models/linear-model:predict'

RESNET_SERVER_URL = 'https://resnet-service-adsoftsito.cloud.okteto.net/v1/models/resnet:predict'
